...
public class MiTv_Caracol_Compare  {
	public static WebDriver driver;
	String baseURL;
	HashMap<Integer,ArrayList<String>> caracolMap = new HashMap<Integer,ArrayList<String>>();
	HashMap<Integer,ArrayList<String>> caracolTitleMap = new HashMap<Integer,ArrayList<String>>();
	HashMap<Integer,ArrayList<String>> caraTimeForTitleMap = new HashMap<Integer,ArrayList<String>>();
	...
	ArrayList<String> caraTimeForTitle = new ArrayList<String>();
	
	ArrayList<String> caracolTitle = new ArrayList<String>();
	...
	ArrayList<String> caraTitle = new ArrayList<String>();
	ArrayList<String> caraTime = new ArrayList<String>();
	...
	@Test
	  public void caracolMitvValidate() throws InterruptedException, ParseException {
		...
		for(int i=1;i<=7;i++){
			...
			List<WebElement> titles = driver.findElements(By.className("info"));

			for(WebElement title:titles){
//				System.out.println("title: "+title.getText());
				caracolTitle.add(title.getText());
			}
			for(WebElement time: times){		
				...
				caraTimeForTitle.add(formatted);
			}
			caraTimeForTitleMap.put(j, (ArrayList<String>) caraTimeForTitle);
			caracolTitleMap.put(j, (ArrayList<String>) caracolTitle);
			caracolMap.put(j, (ArrayList<String>) caracolTime);
			
			caracolTime = new ArrayList<String>();
			caracolTitle = new ArrayList<String>();
			caraTimeForTitle = new ArrayList<String>();
			j++;
		}
		...
		for(int i=caracolday-1;i<7;i++) {
			...
			caraTitle = caracolTitleMap.get(i);
			caraTime = caraTimeForTitleMap.get(i);
...
//					System.out.println("caratitle value for temp: "+temp+"   iter: "+iter+" = "+caraTitle.get(iter));
					if(temp.equals(diff)) {
						System.out.println("::: Title:" +caraTitle.get(iter)+"\n");
					}
					iter++;
				}				
				count++;
